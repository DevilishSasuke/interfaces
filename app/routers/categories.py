...
async def add_new_category(category: CategoryAdd, db: AsyncSession = Depends(get_db_session)) -> CategoryS:
...
async def update_category(category: CategoryUpd, db: AsyncSession = Depends(get_db_session)) -> CategoryS:
